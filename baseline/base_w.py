...
def baseline():
    ...
    outputFile = "/tmp/" + UserInputFile.split("/")[-1][:-4] + ".mc"
    ...
    cmd = "./sharpSAT -decot 10 -decow 100 -tmpdir . -cs 3500 " + UserInputFile + "> " + outputFile
    os.system(cmd)
    ...
    indVarList = list(chainform.Transform(UserInputFile, inputFile, 4))
    ...
    print("input benchmark: ", UserInputFile.split("/")[-1])
